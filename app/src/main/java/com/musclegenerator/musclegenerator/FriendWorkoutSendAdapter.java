...
public class FriendWorkoutSendAdapter extends RecyclerView.Adapter<FriendWorkoutSendAdapter.ViewHolder> {

    List<AddFriendItem> itemsa;
    OnCardClickListener onCardClickListener;
    public FriendWorkoutSendAdapter(ArrayList<AddFriendItem> items ){
        super();
